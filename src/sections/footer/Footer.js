...
import { faCopyright } from '@fortawesome/duotone-light-svg-icons';
        ...
        <div className={`${styles.footerComponent} container`}>
            ...
            <div className={`${styles.footerContainer} row `} >
                ...
                <div className='col-sm-12 col-lg-4'>
                    ...
                    <p><b>Phone:</b> +2349033414253</p>
                    <p><b>Email:</b> badmususman50@gmail.com</p>
                ...
                <div className='col-sm-12 col-lg-4'>
                    ...
                    <li className="nav-item dropdown noHover">
                        ...
                        <ul className="dropdown-menu">
                            <NavLink to={'images'}>  <li><a className="dropdown-item" href="#">   Images</a></li></NavLink>
                            <NavLink to={'videos'} ><li><a className="dropdown-item" href="#">Videos</a></li></NavLink>
                ...
                <div className={`${styles.lastFoot} col-sm-12 col-lg-12`}>
                    ...
                    <p><FontAwesomeIcon icon={faCopyright} />{` ${year}`} <b>naptip-ikd</b> All Rights reserved</p>
